...
function AccountItem() {
    return (
        <div className={cx('wrapper')}>
            <Image
                className={cx('avatar')}
                src="https://p16-sign-sg.tiktokcdn.com/tiktok-obj/41fe3e0b2b0ff2cfab37c99e60da5cb5~c5_300x300.webp?lk3s=a5d48078&x-expires=1705276800&x-signature=zmxKnqPNzMkJ3HTM7n6OWzLtPPE%3D"
                alt="Nguyen Van A"

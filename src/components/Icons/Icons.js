export const MagnifyingGlassIcon = ({ width = '2.4rem', height = '2.4rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const CircleXmarkIcon = ({ width = '1.6rem', height = '1.6rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const CircleNotchIcon = ({ width = '1.6rem', height = '1.6rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const CircleCheckIcon = ({ width = '1.4rem', height = '1.4rem', className, fontSize = '1.4rem' }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const EllipsisVerticalIcon = ({ width = '2rem', height = '2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const CircleQuestionIcon = ({ width = '2rem', height = '2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const CircleKeyboardIcon = ({ width = '2rem', height = '2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const CaretUpIcon = ({ width = '2.4rem', height = '0.8rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const PaperPlaneIcon = ({ width = '2.6rem', height = '2.6rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const ArrowRightToBracketIcon = ({ width = '2rem', height = '2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const HouseIcon = ({ width = '3.2rem', height = '3.2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const HouseActiveIcon = ({ width = '3.2rem', height = '3.2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const ArrowLeftToPersonIcon = ({ width = '3.2rem', height = '3.2rem', fontSize = '2.4rem', className }) => {
    const divStyles = {
        width,
        height,
        fontSize,
...
export const VideoPlayIcon = ({ width = '3.2rem', height = '3.2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const VideoPlayActiveIcon = ({ width = '3.2rem', height = '3.2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const BubbleEllipsisRightFillIcon = ({ width = '2.4rem', height = '2.4rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const BookmarkFillIcon = ({ width = '2.4rem', height = '2.4rem', className }) => {
    return (
...
export const ShareFillIcon = ({ width = '2.4rem', height = '2.4rem', className }) => {
    return (
        <svg className={className} width={width} height={height} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path
                fill="currentColor"
...
export const ThinPlusIcon = ({ width = '1.4rem', height = '1.4rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const VolumeXmarkIcon = ({ width = '2.4rem', height = '2.4rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const VolumeMediumIcon = ({ width = '2.4rem', height = '2.4rem', className }) => {
    return (
        <svg
            className={className}
            width={width}

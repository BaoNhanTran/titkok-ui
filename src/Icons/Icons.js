...
export const CircleTikTokIcon = ({ width = '2rem', height = '2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const HouseFillIcon = ({ width = '3.2rem', height = '3.2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const PersonArrowLeftIcon = ({ width = '3.2rem', height = '3.2rem', fontSize = '2.4rem', className }) => {
    const divStyle = {
        width,
        height,
        padding: '4px',
...
export const PersonArrowLeftFillIcon = ({ width = '3.2rem', height = '3.2rem', fontSize = '2.4rem', className }) => {
    const divStyle = {
        width,
        height,
        padding: '4px',
...
export const VideoPlayFillIcon = ({ width = '3.2rem', height = '3.2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const LargeToSmallRectangleIcon = ({ width = '2.4rem', height = '2.4rem', className, fontSize = '2.1rem' }) => {
    const divStyle = {
        width,
        height,
        display: 'flex',
...
export const PlayIcon = ({ className, width = '6rem', height = '6rem' }) => {
    const divStyle = {
        display: 'flex',
        alignItems: 'center',
        justifyContent: 'center',
        ...
        height,
        borderRadius: '50%',
        backgroundColor: 'rgba(22, 24, 35, 0.34)',
    };
    return (
        <div className={className} style={divStyle}>
            <svg
...
export const PauseIcon = ({ className, width = '6rem', height = '6rem' }) => {
    const divStyle = {
        display: 'flex',
        alignItems: 'center',
        justifyContent: 'center',
